...
asm_commands = {
    ...
    "neg": ["@SP", "A=M-1", "M=-M"],
    "eq": lambda count: ["@SP", "AM=M-1", "D=M", "@NEG_Y_" + str(count), "D;JLT", "@SP", "A=M-1","D=M", "@NEG_X_POS_Y_" + str(count),
    ...
    "gt": lambda count: ["@SP", "AM=M-1", "D=M", "@NEG_Y_" + str(count), "D;JLT", "@SP", "A=M-1", "D=M","@NEG_X_POS_Y_" + str(count),
                         ...
                         "(END_" + str(count) + ")"],
    "lt": lambda count: ["@SP", "AM=M-1", "D=M", "@NEG_Y_" + str(count), "D;JLT", "@SP", "A=M-1", "D=M", "@NEG_X_POS_Y_" + str(count),
                         "D;JLT", "@SP", "A=M", "D=M", "A=A-1", "D=M-D",
                         "@LOWER_" + str(count), "D;JLT", "@GREATER_" + str(count), "0;JMP",
                         "(NEG_Y_" + str(count) + ")", "@SP", "A=M-1", "D=M", "@NEG_Y_POS_X_" + str(count), "D;JGT", "@SP",
